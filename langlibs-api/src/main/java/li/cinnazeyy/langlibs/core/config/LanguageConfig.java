...
public record LanguageConfig(
        ...
        LanguageSection da_DK,
        LanguageSection es_ES,
        LanguageSection hu_HU,
        LanguageSection it_IT,
        LanguageSection nl_NL,
        LanguageSection ro_RO,
        LanguageSection cs_CZ,
        LanguageSection pl_PL,
        LanguageSection sk_SK,
